...
Status: _This paper is published in Journal of Climate [DOI: 10.1175/JCLI-D-24-0316.1](DOI: 10.1175/JCLI-D-24-0316.1). Relevant model output and observational/reanalysis data are available at [https://zenodo.org/records/13941966](https://zenodo.org/records/13941966). We welcome any comments, questions, or suggestions. Please email your feedback to (dervlak@uci.edu)._
